...
unsigned char chip8_fontset_interactive[80] =
{
...
void chip8_interactive::init()
{
	...
	// Load fontset
	for(int i = 0; i < 80; ++i)
		memory[i] = chip8_fontset_interactive[i];
...
void chip8_interactive::debugRender()
{
	// Draw
	for(int y = 0; y < 32; ++y)
	{
...
bool chip8_interactive::loadApplication(const char * filename)
{
	init();
	printf("Loading: %s\n", filename);
